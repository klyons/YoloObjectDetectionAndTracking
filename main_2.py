    ...
    def run(self):
        ...
        while True:
            ...
            for i in new_objects:
                # write code to check that our object is a cat
                pdb.set_trace() # this will help us seperate out classes of objects
                if i.names == {16: 'cat'}:
                    #has a center point of the object
                    # center_x, center_y = (x -1, x, x + 1) / 3  # r, g, b (y -1, y, y + 1) / 3
                    #color determination if 
                    pass
